...
class Updater:
    ...
    def _create_generated_package(catkin_ws=DEF_CATKIN_WS):
        ...
        cmd = '''bash -c "
                    ...
                    cp noovelia_fl_stack/robin/robin_updater/cfg/CMakeLists.txt robin_bridge_generated/
                    cp noovelia_fl_stack/robin/robin_updater/cfg/package.xml robin_bridge_generated/
                    cp noovelia_fl_stack/robin/robin_updater/cfg/run.sh robin_bridge_generated/launch
                    cp noovelia_fl_stack/robin/robin_updater/cfg/run.launch robin_bridge_generated/launch
                    cp noovelia_fl_stack/robin/robin_bridge/include/robin_bridge/structs.h robin_bridge_generated/include/robin_bridge_generated/
                    cp noovelia_fl_stack/robin/robin_bridge/src/robin_node.cpp robin_bridge_generated/src/
                    cp noovelia_fl_stack/robin/robin_bridge/src/robin_bridge/robin_inst.cpp robin_bridge_generated/src/robin_bridge_generated/
